// FIX: To avoid global type conflicts, removed named Request/Response imports and used fully qualified express.Request and express.Response types in handlers.
// FIX: The previous attempt to fix type conflicts was incorrect. Explicitly importing Request and Response from 'express' is the correct way to resolve ambiguity with global types.
